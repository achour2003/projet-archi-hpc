...
Les expériences ont été réalisées sur un ordinateur portable équipé d'un processeur Intel de 13\up{ème} génération. Le tableau~\ref{tab:config_materielle} résume les caractéristiques principales.
...
Fréquence de base (P-cores) & 2,6 GHz \\
Fréquence Turbo max & 4,9 GHz \\
Mémoire RAM & 32 Go DDR5-4800 \\
\bottomrule
\end{tabular}
\end{table}
