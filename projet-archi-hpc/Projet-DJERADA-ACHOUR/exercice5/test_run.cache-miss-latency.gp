...
# (by Stefan.Manegold@cwi.nl, http://www.cwi.nl/~manegold/)
 ...
 set output 'test_run.cache-miss-latency.ps'
...
#set output 'test_run.cache-miss-latency.gif'
set data style linespoints
set key below
set title 'test_run.cache-miss-latency'
...
'test_run.cache-miss-latency.data' using 1:($7-0.100000) title '16' with linespoints lt 1 pt 3 , \
'test_run.cache-miss-latency.data' using 1:($13-0.100000) title '8' with linespoints lt 2 pt 4
set nolabel
set noarrow
